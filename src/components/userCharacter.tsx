    ...
    <div className=''>
      <div className='flex-1 truncate w-fit border-slate-700 border-2 p-1.5 -m-1.5 rounded-lg'>
        <div className='flex items-center space-x-1'>
          {" "}
          <span className='flex-shrink-0 inline-block px-2 py-0.5 text-black text-xs font-medium bg-amber-300 rounded-full'>
            {character.iLevel.number}
          </span>
          <span
            className={`flex-shrink-0 inline-block px-1.5 py-0.5 text-green-800 text-xs font-medium  ${
